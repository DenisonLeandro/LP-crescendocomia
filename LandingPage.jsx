    ...
    <div className="min-h-screen text-dark-black relative selection:bg-blue-light selection:text-blue-primary font-inter">
      ...
      */}
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* ------------------------------------------------------------- */
        /* Section 8 & 9 Custom Styles                                   */
        /* ------------------------------------------------------------- */

        /* Custom Keyframes for Mesh movement in CTA Final */
        @keyframes ctaMesh1 {
          0% { transform: translate(0, 0) scale(1); }
        ...
        .cta-mesh-animated-1 {
          animation: ctaMesh1 12s infinite alternate ease-in-out;
        }
        .cta-mesh-animated-2 {
          animation: ctaMesh2 12s infinite alternate ease-in-out;
          animation-delay: -3s;
        }

        /* Continuous rotation for CTA background geometric circles */
        @keyframes ctaRotateCw {
          from { transform: translateY(-50%) rotate(0deg); }
          to { transform: translateY(-50%) rotate(360deg); }
        }
        @keyframes ctaRotateCcw {
          from { transform: translateY(-50%) rotate(360deg); }
          to { transform: translateY(-50%) rotate(0deg); }
        }
        .cta-circle-cw {
          animation: ctaRotateCw 30s linear infinite;
        }
        .cta-circle-ccw {
          animation: ctaRotateCcw 40s linear infinite;
        }
        .cta-circle-cw-fast {
          animation: ctaRotateCw 20s linear infinite;
        }
        ...
        /* Sliding shimmer hover effect on primary button */
        .btn-shimmer {
          position: relative;
          overflow: hidden;
        }
        ...
        *:focus-visible {
        ...
        /* Variação para elementos sobre fundo escuro */
        .section-dark *:focus-visible {
          outline-color: rgba(255, 255, 255, 0.8);
        }

        /* Isolar hover states para dispositivos que suportam hover real (mouse) */
        @media (hover: none) {
          /* Em touch devices, remover todos os efeitos de hover nos cards */
          .platform-card:hover,
          .feature-card:hover,
